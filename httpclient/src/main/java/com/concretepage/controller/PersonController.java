...
public class PersonController {
	...
	@RequestMapping(value = "/saveJson/{mediaId}", method = RequestMethod.POST, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	public Map<String, ?> saveJson(@RequestBody Map<String, Object> requestBody, @PathVariable Integer mediaId) {
